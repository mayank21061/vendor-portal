...
const ClientsForm = ({ open, setOpen }) => {
  ...
  const validationSchema = yup.object({
    ...
    whAddress: yup.string().required('Warehouse Address is required'),
    whState: yup.string().required('Warehouse State is required'),
    whCity: yup.string().required('Warehouse City is required'),
    whPincode: yup
      .string()
